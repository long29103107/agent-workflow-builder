...
> Archived implementation plan. The active behavior is documented in `docs/knowledge/services/agentworkflow-api.md` and `docs/knowledge/services/agent-workflow-ui.md`.
