...
| [003-durable-orchestration](./003-durable-orchestration/PHASE_SUMMARY.md) | Durable Orchestration, Approval, And Evidence | `in progress` | 2/7 |
...
1. Read the relevant `PHASE_SUMMARY.md`.
2. Select or create the task file using `TASK_TEMPLATE.md`.
